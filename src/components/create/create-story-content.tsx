...
import { Upload, Palette, FileText, Sparkles } from 'lucide-react';
...
export function CreateStoryContent() {
  ...
  return (
    <div className="space-y-2 sm:space-y-8 min-h-screen flex flex-col">
      {/* Header */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 sm:gap-8 max-w-5xl mx-auto px-2 sm:px-4 flex-1">
        {creationModes.map((mode) => {
          ...
          return (
            ...
            >
              ...
              <CardContent className="p-2 sm:p-8 space-y-2 sm:space-y-6">
                {/* Icon and Title */}
                ...
                <div className="space-y-0.5 sm:space-y-4">
                  {mode.features.map((feature, index) => (
                    <div key={index} className={`flex items-center gap-1.5 ${index > 2 ? 'hidden sm:flex' : ''}`}>
                ...
                <Button 
                  asChild 
                  className="w-full text-xs sm:text-xl py-3 sm:py-8 font-bold" 
                  size="lg"
