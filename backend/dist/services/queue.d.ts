...
export declare const imageQueue: Queue<ImageGenerationJobData, any, string>;
export declare const setJobProgress: (jobId: string, progress: JobProgress) => Promise<void>;
export declare const getJobProgress: (jobId: string) => Promise<JobProgress | null>;
export declare const addImageGenerationJob: (jobData: ImageGenerationJobData) => Promise<void>;
